...
# master node
DEFAULT_MASTER_NODE_CPU=1B
DEFAULT_MASTER_NODE_RAM=1024
DEFAULT_MASTER_NODE_DISK_SIZE_GB=15

# worker node
DEFAULT_WORKER_NODE_CPU=1B
DEFAULT_WORKER_NODE_RAM=1024
DEFAULT_WORKER_NODE_DISK_SIZE_GB=15

# load balancer node
DEFAULT_LOAD_BALANCER_NODE_CPU=1B
DEFAULT_LOAD_BALANCER_NODE_RAM=1024
DEFAULT_LOAD_BALANCER_NODE_DISK_SIZE_GB=15
